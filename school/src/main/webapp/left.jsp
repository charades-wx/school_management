...
<table height="100%" cellspacing=0 cellpadding=0 width=170   background=./img/menu_bg.jpg border=0>
    <tr>
        <td valign=top align=middle>
            ...
            <c:forEach items="${user.role.menus}" var="menu1" varStatus="va">
                <table cellspacing=0 cellpadding=0 width=150 border=0>
                    <tr height=22>
                        <td style="padding-left: 30px" background=./img/menu_bt.jpg>
                            <a     class=menuparent onclick=expand(${va.count})  href="javascript:void(0);">${menu1.menuname}</a>
                        </td>
                    </tr>
                    <tr height=4>
                        <td></td>
                ...
                <table id=child${va.count} style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
