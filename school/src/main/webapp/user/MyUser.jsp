	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr  width="120px;">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="userSex" <c:if test="${user.userSex=='男'}">checked</c:if> value="男" />男
                        <input type="radio" name="userSex" <c:if test="${user.userSex=='女'}">checked</c:if> value="女"/>女
                    </td>
                </tr>
